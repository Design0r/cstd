...
static size_t string_len(const String s) { return s.len; }
...
static Str str_trim(const Str s) { return str_trim_right(str_trim_left(s)); }

static size_t str_len(const Str s) { return s.len; }

static Str str_copy(const Str s) { return s; }
...
#ifdef __cplusplus
Str Str::trim_left() { return str_trim_left(*this); }

Str Str::trim_right() { return str_trim_right(*this); }

Str Str::trim() { return str_trim(*this); }

size_t Str::length() { return str_len(*this); }
...
bool Str::eq(Str b) { return str_eq(*this, b); }

bool Str::startswith_str(Str b) { return str_startswith_str(*this, b); }

bool Str::startswith_cstr(const char *cstr) {
  return str_startswith_cstr(*this, cstr);
}

String Str::to_string() { return str_to_string(*this); }

void Str::to_cstr(char *buf) { str_to_cstr(*this, buf); }

char *Str::to_cstr() { return str_to_cstr_m(*this); }
